...
import 'package:blog/screen/login_reg_pass/respass/error_mailscreen/error.dart';
import 'package:blog/screen/login_reg_pass/respass/sucess_mailscreen/sucess.dart';
...
class resPassScreen extends StatefulWidget {
  const resPassScreen({super.key});

  @override
  State<resPassScreen> createState() => _resPassScreenState();
}

// ignore: camel_case_types
class _resPassScreenState extends State<resPassScreen> {
  // form key
  ...
  Future<void> postResetPass() async {
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        child: Text(
                          "Kullanıcı Şifrenizimi Unuttunuz?",
                          style: GoogleFonts.nunito(
