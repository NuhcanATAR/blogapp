...
void main() async {
  ...
  runApp(
    const MaterialApp(
      home: futbolCategorysScreen(),
    ),
  );
}

// ignore: camel_case_types
class futbolCategorysScreen extends StatefulWidget {
  const futbolCategorysScreen({super.key});

  @override
  State<futbolCategorysScreen> createState() => _futbolCategorysScreenState();
}

// ignore: camel_case_types
class _futbolCategorysScreenState extends State<futbolCategorysScreen> {
  // doga category
  Query<Map<String, dynamic>> collectionReference = FirebaseFirestore.instance
      .collection("blogs")
      .where("category", isEqualTo: "Futbol");
  @override
