...
void main() async {
  ...
  runApp(
    const MaterialApp(
      home: yapiCategorysScreen(),
    ),
  );
}

// ignore: camel_case_types
class yapiCategorysScreen extends StatefulWidget {
  const yapiCategorysScreen({super.key});

  @override
  State<yapiCategorysScreen> createState() => _yapiCategorysScreenState();
}

// ignore: camel_case_types
class _yapiCategorysScreenState extends State<yapiCategorysScreen> {
  // doga category
  Query<Map<String, dynamic>> collectionReference = FirebaseFirestore.instance
      .collection("blogs")
      .where("category", isEqualTo: "Yapı");
  @override
