...
void main() async {
  ...
  runApp(
    const MaterialApp(
      home: sporCategorysScreen(),
    ),
  );
}

// ignore: camel_case_types
class sporCategorysScreen extends StatefulWidget {
  const sporCategorysScreen({super.key});

  @override
  State<sporCategorysScreen> createState() => _sporCategorysScreenState();
}

// ignore: camel_case_types
class _sporCategorysScreenState extends State<sporCategorysScreen> {
  // doga category
  Query<Map<String, dynamic>> collectionReference = FirebaseFirestore.instance
      .collection("blogs")
      .where("category", isEqualTo: "Spor");
  @override
