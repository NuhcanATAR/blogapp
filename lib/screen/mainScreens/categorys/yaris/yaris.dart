...
void main() async {
  ...
  runApp(
    const MaterialApp(
      home: yarisCategorysScreen(),
    ),
  );
}

// ignore: camel_case_types
class yarisCategorysScreen extends StatefulWidget {
  const yarisCategorysScreen({super.key});

  @override
  State<yarisCategorysScreen> createState() => _yarisCategorysScreenState();
}

// ignore: camel_case_types
class _yarisCategorysScreenState extends State<yarisCategorysScreen> {
  // doga category
  Query<Map<String, dynamic>> collectionReference = FirebaseFirestore.instance
      .collection("blogs")
      .where("category", isEqualTo: "Yarış");
  @override
