...
void main() async {
  ...
  runApp(
    const MaterialApp(
      home: dogaCategorysScreen(),
    ),
  );
}

// ignore: camel_case_types
class dogaCategorysScreen extends StatefulWidget {
  const dogaCategorysScreen({super.key});

  @override
  State<dogaCategorysScreen> createState() => _dogaCategorysScreenState();
}

// ignore: camel_case_types
class _dogaCategorysScreenState extends State<dogaCategorysScreen> {
  // doga category
  Query<Map<String, dynamic>> collectionReference = FirebaseFirestore.instance
      .collection("blogs")
      .where("category", isEqualTo: "Doğa");
  @override
